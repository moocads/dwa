...
export const fr: Translations = {
  ...
  ecosystem: {
    ...
    gridHintDesktop:
      "La liquidité circule depuis DWA Swap au centre vers chaque module. Survolez ou touchez une carte pour voir son rôle.",
    modules: {
      rwa: {
        name: "Protocole RWA",
  ...
  vision: {
    label: "NOTRE VISION",
    title: "Une civilisation d'actifs auto-gouvernée.",
    titleHighlight: "Pour le monde.",
    p1: "Des actifs de partout, accessibles à tous.",
    p2: "Chaque stratégie est définie par vous, exécutée par l'AI.",
  },
  partners: {
