...
export const en: Translations = {
  ...
  ecosystem: {
    ...
    gridHintDesktop:
      "Liquidity flows from DWA Swap at the center out to every module. Hover or tap a card to read what it does.",
    modules: {
      rwa: {
        name: "RWA Protocol",
  ...
  vision: {
    label: "OUR VISION",
    title: "A Self-Governing Asset Civilization.",
    titleHighlight: "For the World.",
    p1: "Assets from everywhere, accessible to everyone.",
    p2: "Every strategy defined by you, executed by AI.",
  },
  partners: {
    title: "Our Partners",
